...
class DavCalendarsApi
{
     ...
     * Adds a new calendar
     *
     * @param  \WT\Client\Calendar\Model\CalendarNew $body body (required)
     *
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Calendar\Model\Calendar
     */
     ...
     * Adds a new calendar
     *
     * @param  \WT\Client\Calendar\Model\CalendarNew $body (required)
     *
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Calendar\Model\Calendar, HTTP status code, HTTP response headers (array of strings)
     */
    public function addCalendarWithHttpInfo($body)
    {
        $returnType = '\WT\Client\Calendar\Model\Calendar';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Calendar\Model\Calendar',
     ...
     *
     * @param  string $calendarUid Calendar UID (required)
     * @param  \WT\Client\Calendar\Model\CalendarUpdate $body body (required)
     *
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $calendarUid Calendar UID (required)
     * @param  \WT\Client\Calendar\Model\CalendarUpdate $body (required)
     *
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
