...
class EasMessagesApi
{
     ...
     * @param  \WT\Client\Calendar\Model\SyncEventUpdate $body body (required)
     *
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Calendar\Model\SyncEventStat
     */
     ...
     *
     * @param  int $folderId Folder ID (required)
     * @param  \WT\Client\Calendar\Model\SyncEventUpdate $body (required)
     *
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Calendar\Model\SyncEventStat, HTTP status code, HTTP response headers (array of strings)
     */
    public function addMessageWithHttpInfo($folderId, $body)
    {
        $returnType = '\WT\Client\Calendar\Model\SyncEventStat';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Calendar\Model\SyncEventStat',
     ...
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Calendar\Model\SyncEvent
     */
     ...
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Calendar\Model\SyncEvent, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMessageWithHttpInfo($folderId, $id)
    {
        $returnType = '\WT\Client\Calendar\Model\SyncEvent';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Calendar\Model\SyncEvent',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \WT\Client\Calendar\Model\SyncEventStat[]
     */
    public function updateMessage($folderId, $id, $body)
    {
        list($response) = $this->updateMessageWithHttpInfo($folderId, $id, $body);
        return $response;
    }
     ...
     * @return array of \WT\Client\Calendar\Model\SyncEventStat[], HTTP status code, HTTP response headers (array of strings)
     */
    public function updateMessageWithHttpInfo($folderId, $id, $body)
    {
        $returnType = '\WT\Client\Calendar\Model\SyncEventStat[]';
        $request = $this->updateMessageRequest($folderId, $id, $body);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMessageAsync($folderId, $id, $body)
    {
        return $this->updateMessageAsyncWithHttpInfo($folderId, $id, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMessageAsyncWithHttpInfo($folderId, $id, $body)
    {
        $returnType = '\WT\Client\Calendar\Model\SyncEventStat[]';
        $request = $this->updateMessageRequest($folderId, $id, $body);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateMessageRequest($folderId, $id, $body)
    {
        // verify the required parameter 'folderId' is set
        if ($folderId === null || (is_array($folderId) && count($folderId) === 0)) {
            throw new \InvalidArgumentException(
