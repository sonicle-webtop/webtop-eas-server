...
class DavCalObjectsApi
{
     ...
     * @param  \WT\Client\Calendar\Model\CalObjectNew $body body (required)
     *
     ...
     *
     * @param  string $calendarUid Calendar UID (required)
     * @param  \WT\Client\Calendar\Model\CalObjectNew $body (required)
     *
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Calendar\Model\CalObject
     */
     ...
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Calendar\Model\CalObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCalObjectWithHttpInfo($calendarUid, $href)
    {
        $returnType = '\WT\Client\Calendar\Model\CalObject';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Calendar\Model\CalObject',
     ...
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Calendar\Model\CalObjectsChanges
     */
     ...
     * @throws \WT\Client\Calendar\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Calendar\Model\CalObjectsChanges, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCalObjectsChangesWithHttpInfo($calendarUid, $syncToken = null, $limit = null)
    {
        $returnType = '\WT\Client\Calendar\Model\CalObjectsChanges';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Calendar\Model\CalObjectsChanges',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
