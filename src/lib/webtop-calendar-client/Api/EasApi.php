...
class EasApi
{
    ...
    {
        $returnType = '\WT\Client\Calendar\Model\EasSyncEventStat';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Calendar\Model\EasSyncEventStat',
    ...
    {
        $returnType = '\WT\Client\Calendar\Model\EasSyncFolder[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Calendar\Model\EasSyncFolder[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\WT\Client\Calendar\Model\EasSyncEvent';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Calendar\Model\EasSyncEvent',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
