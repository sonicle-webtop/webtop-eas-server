...
use WT\Client\Tasks\ApiException;
use WT\Client\Tasks\Configuration;
use WT\Client\Tasks\HeaderSelector;
use WT\Client\Tasks\ObjectSerializer;

/**
 * EasApi Class Doc Comment
 *
 * @category Class
 * @package  WT\Client\Tasks
 * @author   Swagger Codegen team
...
class EasApi
{
     ...
     * Adds a message
     *
     * @param  \WT\Client\Tasks\Model\EasSyncTaskUpdate $body body (required)
     * @param  string $folderId Folder ID (required)
     *
     * @throws \WT\Client\Tasks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Tasks\Model\EasSyncTaskStat
     */
    public function addMessage($body, $folderId)
    {
        list($response) = $this->addMessageWithHttpInfo($body, $folderId);
        return $response;
    }
     ...
     * Adds a message
     *
     * @param  \WT\Client\Tasks\Model\EasSyncTaskUpdate $body (required)
     * @param  string $folderId Folder ID (required)
     *
     * @throws \WT\Client\Tasks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Tasks\Model\EasSyncTaskStat, HTTP status code, HTTP response headers (array of strings)
     */
    public function addMessageWithHttpInfo($body, $folderId)
    {
        $returnType = '\WT\Client\Tasks\Model\EasSyncTaskStat';
        $request = $this->addMessageRequest($body, $folderId);
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Tasks\Model\EasSyncTaskStat',
     ...
     */
    public function addMessageAsync($body, $folderId)
    {
        return $this->addMessageAsyncWithHttpInfo($body, $folderId)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function addMessageAsyncWithHttpInfo($body, $folderId)
    {
        $returnType = '\WT\Client\Tasks\Model\EasSyncTaskStat';
        $request = $this->addMessageRequest($body, $folderId);
     ...
     */
    protected function addMessageRequest($body, $folderId)
    {
     ...
     * @throws \WT\Client\Tasks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Tasks\Model\EasSyncFolder[]
     */
     ...
     * @throws \WT\Client\Tasks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Tasks\Model\EasSyncFolder[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getFoldersWithHttpInfo()
    {
        $returnType = '\WT\Client\Tasks\Model\EasSyncFolder[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Tasks\Model\EasSyncFolder[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \WT\Client\Tasks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Tasks\Model\EasSyncTask
     */
    public function getMessage($folderId, $id)
    {
        list($response) = $this->getMessageWithHttpInfo($folderId, $id);
        return $response;
    }
     ...
     * @throws \WT\Client\Tasks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Tasks\Model\EasSyncTask, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMessageWithHttpInfo($folderId, $id)
    {
        $returnType = '\WT\Client\Tasks\Model\EasSyncTask';
        $request = $this->getMessageRequest($folderId, $id);
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Tasks\Model\EasSyncTask',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMessageAsync($folderId, $id)
    {
        return $this->getMessageAsyncWithHttpInfo($folderId, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMessageAsyncWithHttpInfo($folderId, $id)
    {
        $returnType = '\WT\Client\Tasks\Model\EasSyncTask';
        $request = $this->getMessageRequest($folderId, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMessageRequest($folderId, $id)
    {
        // verify the required parameter 'folderId' is set
        if ($folderId === null || (is_array($folderId) && count($folderId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     *
     * Gets sync messages data for a folder
     *
     * @param  string $folderId Folder ID (required)
     ...
     * @return \WT\Client\Tasks\Model\EasSyncTaskStat[]
     */
    public function getMessagesStats($folderId, $cutoffDate = null)
    {
        list($response) = $this->getMessagesStatsWithHttpInfo($folderId, $cutoffDate);
        return $response;
    }
     ...
     * @return array of \WT\Client\Tasks\Model\EasSyncTaskStat[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getMessagesStatsWithHttpInfo($folderId, $cutoffDate = null)
    {
        $returnType = '\WT\Client\Tasks\Model\EasSyncTaskStat[]';
        $request = $this->getMessagesStatsRequest($folderId, $cutoffDate);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMessagesStatsAsync($folderId, $cutoffDate = null)
    {
        return $this->getMessagesStatsAsyncWithHttpInfo($folderId, $cutoffDate)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getMessagesStatsAsyncWithHttpInfo($folderId, $cutoffDate = null)
    {
        $returnType = '\WT\Client\Tasks\Model\EasSyncTaskStat[]';
        $request = $this->getMessagesStatsRequest($folderId, $cutoffDate);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getMessagesStatsRequest($folderId, $cutoffDate = null)
    {
        // verify the required parameter 'folderId' is set
        if ($folderId === null || (is_array($folderId) && count($folderId) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \WT\Client\Tasks\Model\EasSyncTaskStat
     */
    public function updateMessage($body, $folderId, $id)
    {
        list($response) = $this->updateMessageWithHttpInfo($body, $folderId, $id);
        return $response;
    }
     ...
     * @return array of \WT\Client\Tasks\Model\EasSyncTaskStat, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateMessageWithHttpInfo($body, $folderId, $id)
    {
        $returnType = '\WT\Client\Tasks\Model\EasSyncTaskStat';
        $request = $this->updateMessageRequest($body, $folderId, $id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMessageAsync($body, $folderId, $id)
    {
        return $this->updateMessageAsyncWithHttpInfo($body, $folderId, $id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMessageAsyncWithHttpInfo($body, $folderId, $id)
    {
        $returnType = '\WT\Client\Tasks\Model\EasSyncTaskStat';
        $request = $this->updateMessageRequest($body, $folderId, $id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateMessageRequest($body, $folderId, $id)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
