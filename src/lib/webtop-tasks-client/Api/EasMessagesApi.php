...
class EasMessagesApi
{
     ...
     * @return \WT\Client\Tasks\Model\SyncTaskStat
     */
     ...
     * @throws \WT\Client\Tasks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Tasks\Model\SyncTaskStat, HTTP status code, HTTP response headers (array of strings)
     */
    public function addMessageWithHttpInfo($folderId, $body)
    {
        $returnType = '\WT\Client\Tasks\Model\SyncTaskStat';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Tasks\Model\SyncTaskStat',
     ...
     * @throws \WT\Client\Tasks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Tasks\Model\SyncTask
     */
     ...
     * @throws \WT\Client\Tasks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Tasks\Model\SyncTask, HTTP status code, HTTP response headers (array of strings)
     */
    public function getMessageWithHttpInfo($folderId, $id)
    {
        $returnType = '\WT\Client\Tasks\Model\SyncTask';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Tasks\Model\SyncTask',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
