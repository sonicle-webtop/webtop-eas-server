...
class EasFoldersApi
{
     ...
     * @return \WT\Client\Tasks\Model\SyncFolder[]
     */
     ...
     * @throws \WT\Client\Tasks\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Tasks\Model\SyncFolder[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getFoldersWithHttpInfo()
    {
        $returnType = '\WT\Client\Tasks\Model\SyncFolder[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Tasks\Model\SyncFolder[]',
