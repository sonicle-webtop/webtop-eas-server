...
class EasApi
{
    ...
    {
        $returnType = '\WT\Client\Contacts\Model\EasSyncContactStat';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Contacts\Model\EasSyncContactStat',
    ...
    {
        $returnType = '\WT\Client\Contacts\Model\EasSyncFolder[]';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Contacts\Model\EasSyncFolder[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    {
        $returnType = '\WT\Client\Contacts\Model\EasSyncContact';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Contacts\Model\EasSyncContact',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \WT\Client\Contacts\Model\EasSyncContactStat
     */
    public function updateMessage($body, $folderId, $id, $picture = null)
    {
        list($response) = $this->updateMessageWithHttpInfo($body, $folderId, $id, $picture);
        return $response;
    }
     ...
     * @return array of \WT\Client\Contacts\Model\EasSyncContactStat, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateMessageWithHttpInfo($body, $folderId, $id, $picture = null)
    {
        $returnType = '\WT\Client\Contacts\Model\EasSyncContactStat';
        $request = $this->updateMessageRequest($body, $folderId, $id, $picture);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMessageAsync($body, $folderId, $id, $picture = null)
    {
        return $this->updateMessageAsyncWithHttpInfo($body, $folderId, $id, $picture)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateMessageAsyncWithHttpInfo($body, $folderId, $id, $picture = null)
    {
        $returnType = '\WT\Client\Contacts\Model\EasSyncContactStat';
        $request = $this->updateMessageRequest($body, $folderId, $id, $picture);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateMessageRequest($body, $folderId, $id, $picture = null)
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
