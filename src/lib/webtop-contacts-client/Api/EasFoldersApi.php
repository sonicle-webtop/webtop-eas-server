...
class EasFoldersApi
{
     ...
     * @return \WT\Client\Contacts\Model\SyncFolder[]
     */
     ...
     * @throws \WT\Client\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Contacts\Model\SyncFolder[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getFoldersWithHttpInfo()
    {
        $returnType = '\WT\Client\Contacts\Model\SyncFolder[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Contacts\Model\SyncFolder[]',
