...
class DavCardsApi
{
     ...
     * @param  \WT\Client\Contacts\Model\CardNew $body body (required)
     *
     ...
     *
     * @param  string $addressBookUid Address book UID (required)
     * @param  \WT\Client\Contacts\Model\CardNew $body (required)
     *
     * @throws \WT\Client\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @throws \WT\Client\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Contacts\Model\Card
     */
     ...
     * @throws \WT\Client\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Contacts\Model\Card, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCardWithHttpInfo($addressBookUid, $href)
    {
        $returnType = '\WT\Client\Contacts\Model\Card';
     ...
     * @throws \WT\Client\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Contacts\Model\CardsChanges
     */
     ...
     * @throws \WT\Client\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Contacts\Model\CardsChanges, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCardsChangesWithHttpInfo($addressBookUid, $syncToken = null, $limit = null)
    {
        $returnType = '\WT\Client\Contacts\Model\CardsChanges';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Contacts\Model\CardsChanges',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
