...
class DavAddressbooksApi
{
     ...
     *
     * @param  \WT\Client\Contacts\Model\AddressBookNew $body body (required)
     *
     * @throws \WT\Client\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \WT\Client\Contacts\Model\AddressBook
     */
     ...
     * Adds a new address book
     *
     * @param  \WT\Client\Contacts\Model\AddressBookNew $body (required)
     *
     * @throws \WT\Client\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \WT\Client\Contacts\Model\AddressBook, HTTP status code, HTTP response headers (array of strings)
     */
    public function addAddressBookWithHttpInfo($body)
    {
        $returnType = '\WT\Client\Contacts\Model\AddressBook';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\WT\Client\Contacts\Model\AddressBook',
     ...
     *
     * @param  string $addressBookUid Address book UID (required)
     * @param  \WT\Client\Contacts\Model\AddressBookUpdate $body body (required)
     *
     * @throws \WT\Client\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     ...
     *
     * @param  string $addressBookUid Address book UID (required)
     * @param  \WT\Client\Contacts\Model\AddressBookUpdate $body (required)
     *
     * @throws \WT\Client\Contacts\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
